...
const data: SectionGuideData = {
  ...
  badge: `Genesis Study`,
  title: `Genesis 27`,
  intro: `The blind Isaac prepares to bless Esau, but Rebekah and Jacob conspire to steal the blessing &mdash; a story of favoritism, deception, and bitter loss in which Esau weeps, Jacob flees to Haran, and the mysterious purpose of God from Genesis 25:23 advances even through deeply flawed people.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Genesis 27 through visual teaching on the stolen blessing, the wreckage of favoritism, the sovereign choice of God, and the warning of Esau&rsquo;s tears in Hebrews 12.`,
  calloutTitle: `Sin's Bitter Harvest, God's Unbroken Purpose`,
  calloutBody: `Genesis 27 refuses to whitewash its characters. Every party reaps a bitter harvest from favoritism and deceit &mdash; yet over the wreckage, the covenant purpose declared in Genesis 25:23 moves forward unbroken. It is a sobering picture of the seriousness of sin and the astonishing grace of a God who accomplishes his good ends even through deeply flawed people.`,
};
