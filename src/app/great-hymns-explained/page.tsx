      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 20px 60px" }}>
        ...
        <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 12, padding: 18, marginBottom: 24, display: "flex", gap: 12, alignItems: "flex-start" }}>
          ...
          <p style={{ color: MUTED, fontSize: 14, lineHeight: 1.7, margin: 0 }}>
            "When you know why a hymn was written — the grief, the crisis, the insight — you will never sing it the same way again. These are not compositions; they are testimonies set to music." Every great hymn has a story.
          </p>
        </div>
