...
const data: SectionGuideData = {
  ...
  intro: `Paul&rsquo;s great letter on the supremacy of Christ &mdash; the magnificent Christ hymn, the fullness of deity dwelling in him, his warning against false teaching, the putting off of the old self and putting on of the new, and the mystery of Christ in you, the hope of glory.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Colossians through visual teaching on the structure of the letter, the supremacy of Christ, and what it means to be complete in him.`,
  calloutTitle: `Complete in Christ`,
  calloutBody: `Colossians stands as the church&rsquo;s great proclamation of the supremacy and all-sufficiency of Jesus Christ. In him the whole fullness of deity dwells, and in him the believer has been made complete &mdash; needing no supplement, no secret knowledge, no added rule. Set your mind on things above, let his word dwell in you richly, and live out the mystery of Christ in you, the hope of glory.`,
};
