...
const data: SectionGuideData = {
  ...
  title: `The Book of 1 Kings`,
  intro: `The rise and fall of Israel&rsquo;s glory &mdash; the wisdom of Solomon, the building of the Temple, the tragic division of the kingdom under Rehoboam and Jeroboam, the slide into idolatry, and the fiery ministry of Elijah against the prophets of Baal.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Kings through visual teaching on the reign of Solomon, the building of the Temple, the division of the kingdom, and the dramatic ministry of Elijah.`,
  calloutTitle: `If the Lord is God, Follow Him`,
  calloutBody: `1 Kings traces the heights of Israel&rsquo;s glory and the depths of its decline, showing that wisdom received is not wisdom retained, and that a divided heart leads a nation astray. Yet through Elijah&rsquo;s witness on Carmel its enduring call still sounds: stop limping between two opinions, and follow the one true God with an undivided heart.`,
};
