...
export default function HamartiologyGuidePage() {
  const [tab, setTab] = usePersistedState<string>("vine_hamart_tab", "overview");
  const [openDef, setOpenDef] = usePersistedState<string>("vine_hamart_def", "");
  const [openFall, setOpenFall] = usePersistedState<string>("vine_hamart_fall", "");
  const [openType, setOpenType] = usePersistedState<string>("vine_hamart_type", "");
  const [openDeceit, setOpenDeceit] = usePersistedState<string>("vine_hamart_dec", "");
  const [journal, setJournal] = usePersistedState<string>("vine_hamart_journal", "");
