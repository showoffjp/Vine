...
const data: SectionGuideData = {
  ...
  badge: `Acts Study`,
  title: `Acts 22`,
  intro: `From the barracks steps Paul addresses the Jerusalem crowd in their own tongue, recounting his upbringing, his Damascus road encounter, and his commission to the Gentiles &mdash; until the word &ldquo;Gentiles&rdquo; sparks a riot and Paul reveals his Roman citizenship to halt the flogging.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Acts 22 through visual teaching on Paul&rsquo;s defense before the crowd, his transformation from persecutor to witness, the Damascus road encounter, and the strategic use of Roman citizenship in the service of the gospel.`,
  calloutTitle: `Testimony and Providence`,
  calloutBody: `Acts 22 shows that the gospel itself is the best defense. Paul answers the mob not with argument but with the story of the risen Christ who met him on the road &mdash; and when violence threatens, the Lord who saved him also works through Roman law and a born citizenship to preserve his servant and carry his witness onward, all the way toward Rome.`,
};
