...
export default function GospelOfMatthewGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_matthew_tab", "overview");
  const [openDisc, setOpenDisc] = usePersistedState<string>("vine_matthew_disc", "");
  const [openPar, setOpenPar] = usePersistedState<string>("vine_matthew_par", "");
  const [journal, setJournal] = usePersistedState<string>("vine_matthew_journal", "");
