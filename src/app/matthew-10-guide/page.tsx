...
const data: SectionGuideData = {
  ...
  title: `The Gospel of Matthew, Chapter 10`,
  intro: `The first great commissioning &mdash; Jesus calls and names the Twelve, sends them to the lost sheep of Israel with authority over disease and demons, warns of persecution among wolves, commands them not to fear the one who knows every sparrow, and lays out the cost of taking up the cross to follow him.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Matthew 10 through visual teaching on the calling of the Twelve, the mission charge, the warning of persecution among wolves, and the call to fearless, cross-bearing discipleship.`,
  calloutTitle: `Sent as Laborers into the Harvest`,
  calloutBody: `Matthew 10 turns watchers into workers. The Twelve who have seen Jesus heal and forgive are now given his authority and sent into a world that will both welcome and resist them. The chapter never softens the cost &mdash; persecution, division, the cross &mdash; yet it surrounds every hard word with the Father&rsquo;s care, the Spirit&rsquo;s help, and the promise that even a cup of cold water given in Christ&rsquo;s name is never forgotten.`,
};
