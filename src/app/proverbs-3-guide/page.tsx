...
const data: SectionGuideData = {
  accent: "#0D9488",
  badge: `Proverbs Chapter Study`,
  title: `Proverbs 3`,
  intro: `&ldquo;Trust in the Lord with all your heart, and do not lean on your own understanding&rdquo; &mdash; a verse-by-verse journey through the great chapter of wisdom: whole-hearted trust, honoring God with the firstfruits, receiving his discipline as love, finding wisdom as a tree of life, and doing good to your neighbor.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Proverbs 3 through visual teaching on whole-hearted trust in the Lord, the fear of the Lord as the beginning of wisdom, honoring God with the firstfruits, and finding wisdom as a tree of life.`,
  calloutTitle: `Trust in the Lord with All Your Heart`,
  calloutBody: `Proverbs 3 gathers the whole of the wise life into a single path: trust God with all your heart, honor him with your wealth, receive his discipline as the love of a delighting Father, lay hold of wisdom as a tree of life, and let it overflow in good done to your neighbor. Its enduring call still steadies every heart that must choose its way: &ldquo;In all your ways acknowledge him, and he will make straight your paths.&rdquo;`,
};
