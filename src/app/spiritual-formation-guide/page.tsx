...
export default function SpiritualFormationGuidePage() {
  const [tab, setTab] = useLocalStorage("vine_sform_tab", "overview");
  const [openDisc, setOpenDisc] = useLocalStorage("vine_sform_disc", "");
  const [openPitfall, setOpenPitfall] = useLocalStorage("vine_sform_pit", "");
  const [planText, setPlanText] = useLocalStorage("vine_sform_plan", "");
  const [journal, setJournal] = useLocalStorage("vine_sform_journal", "");
