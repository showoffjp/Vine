...
const data: SectionGuideData = {
  ...
  title: `Psalm 73`,
  intro: `Why Do the Wicked Prosper? Asaph&rsquo;s honest wrestle with envy, his near-stumbling faith, the perspective-shifting moment in God&rsquo;s sanctuary, and the profound declaration &ldquo;Whom have I in heaven but you?&rdquo;`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Psalm 73 through visual teaching on Asaph&rsquo;s struggle with the prosperity of the wicked, the perspective found in God&rsquo;s sanctuary, and the surpassing worth of God himself.`,
  calloutTitle: `But for Me It Is Good to Be Near God`,
  calloutBody: `Psalm 73 does not resolve the question of why the righteous suffer by giving a philosophical answer. It resolves it by a personal encounter &mdash; a turning to God in the sanctuary that reorients everything. Asaph exits the psalm with God as his portion forever, having discovered that nearness to God is itself the good he was looking for. &ldquo;My flesh and my heart may fail, but God is the strength of my heart and my portion forever&rdquo; (v.26).`,
};
