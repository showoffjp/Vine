          ...
          {mode === "interests" ? (
            ...
            <>
              ...
              <div className="space-y-3 mb-4">
                <div className="grid grid-cols-2 gap-3">
                  <input placeholder="First name" className="px-4 py-3 rounded-xl text-sm outline-none w-full" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
                  <input placeholder="Last name" className="px-4 py-3 rounded-xl text-sm outline-none w-full" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
                </div>
                <input type="email" placeholder="Email address" className="w-full px-4 py-3 rounded-xl text-sm outline-none" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
                <div className="relative">
                  <input type={showPassword ? "text" : "password"} placeholder="Create a password" className="w-full px-4 py-3 rounded-xl text-sm outline-none pr-10" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
              ...
              <button onClick={() => setMode("interests")} className="btn-gold w-full py-3.5 rounded-xl mb-4 flex items-center justify-center gap-2 group">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {["Google", "Apple"].map(p => (
                  <button key={p} className="py-3 rounded-xl text-sm font-medium transition-colors" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#A0A0C0" }}
            ...
            <>
              ...
              <div className="space-y-3 mb-4">
                <input type="email" placeholder="Email address" className="w-full px-4 py-3 rounded-xl text-sm outline-none" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
                <div className="relative">
                  <input type={showPassword ? "text" : "password"} placeholder="Password" className="w-full px-4 py-3 rounded-xl text-sm outline-none pr-10" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#F2F2F8" }} />
                  <button className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: "#6A6A88" }} onClick={() => setShowPassword(!showPassword)}>
                    {showPassword ? <EyeOff size={16} /> : <Eye size={16} />}
                  </button>
                </div>
