...
const data: SectionGuideData = {
  ...
  intro: `Paul&rsquo;s shortest and most personal letter &mdash; a tender appeal on behalf of Onesimus, the runaway slave turned beloved brother, in which the gospel transforms a master-slave relationship into family and displays its power to reconcile.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Philemon through visual teaching on Paul&rsquo;s tender appeal, the story of Onesimus the runaway slave, and the gospel&rsquo;s power to reconcile and to make brothers of those once divided.`,
  calloutTitle: `Charge That to My Account`,
  calloutBody: `In this little letter the whole gospel shines: a guilty runaway who cannot pay his debt, a mediator who says &ldquo;charge that to my account,&rdquo; and a welcome offered as though to Paul himself. So Christ takes our debt upon his own account and presents us to the Father as beloved &mdash; turning enemies into brothers and displaying forever the reconciling power of grace.`,
};
