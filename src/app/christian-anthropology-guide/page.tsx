...
export default function ChristianAnthropologyGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_anthropo_tab", "overview");
  const [constOpen, setConstOpen] = usePersistedState<string>("vine_anthropo_const", "");
  const [willOpen, setWillOpen] = usePersistedState<string>("vine_anthropo_will", "");
  const [journal, setJournal] = usePersistedState<string>("vine_anthropo_journal", "");
