...
export default function WomenTheologyGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_women_tab", "overview");
  const [openDebate, setOpenDebate] = usePersistedState<string>("vine_women_deb", "");
  const [openEarly, setOpenEarly] = usePersistedState<string>("vine_women_ec", "");
  const [journal, setJournal] = usePersistedState<string>("vine_women_journal", "");
