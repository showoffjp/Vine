...
const data: SectionGuideData = {
  ...
  title: `The Book of 2 Samuel`,
  intro: `The reign of David &mdash; his rise to the throne and the ark brought to Jerusalem, the everlasting Davidic covenant, his fall with Bathsheba and his repentance, the consequences of sin in his house, and the portrait of a flawed king after God&rsquo;s own heart.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 2 Samuel through visual teaching on the structure of the book, the everlasting Davidic covenant, and the account of David&rsquo;s sin and repentance.`,
  calloutTitle: `A Throne Established Forever`,
  calloutBody: `Second Samuel holds together the glory and the grief of David&rsquo;s reign &mdash; the everlasting covenant and the grievous fall, the dancing before the ark and the weeping for a son. Through a flawed yet repentant king it points beyond itself to a greater Son of David, Jesus, whose throne is truly established forever.`,
};
