...
export default function EvangelismGuide() {
  const [tab, setTab] = useLocalStorage("vine_evang_tab", "overview");
  const [msgOpen, setMsgOpen] = useLocalStorage("vine_evang_msg", "");
  const [objOpen, setObjOpen] = useLocalStorage("vine_evang_obj", "");
  const [journal, setJournal] = useLocalStorage("vine_evang_journal", "");
