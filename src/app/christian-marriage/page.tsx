...
const THEOLOGY = [
  ...
  { title: "When Marriage Is Hard", verse: "Matthew 19:6", body: "Jesus' teaching on divorce in Matthew 19 is demanding: what God has joined, humans should not separate. But it was spoken in the context of men divorcing wives for trivial reasons (Deuteronomy 24 interpretations). Jesus raised the bar — not to trap people in abusive situations but to protect the vulnerable and take covenant seriously. Hard marriages are not signs of God's absence; they may be the site of the most profound formation." },
];
...
export default function ChristianMarriagePage() {
  ...
  const [selected, setSelected] = useState<string | null>("Newlyweds (0-3 years)");
