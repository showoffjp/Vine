...
export default function EcclesiologyGuidePage() {
  const [tab, setTab] = usePersistedState<string>("vine_eccl_tab", "overview");
  const [openGov, setOpenGov] = usePersistedState<string>("vine_eccl_gov", "");
  const [openMark, setOpenMark] = usePersistedState<string>("vine_eccl_mark", "");
  const [journal, setJournal] = usePersistedState<string>("vine_eccl_journal", "");
