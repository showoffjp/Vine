      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 70% 50% at 50% 30%, rgba(58,125,86,0.12) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "linear-gradient(rgba(58,125,86,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(58,125,86,0.04) 1px, transparent 1px)",
