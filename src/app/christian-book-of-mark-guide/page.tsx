...
const data: SectionGuideData = {
  ...
  intro: `The fast-paced gospel of action &mdash; Jesus the suffering servant, the question of his identity, the messianic secret, the way of the cross, and the passion narrative that ends at the empty tomb.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Mark through visual teaching on the structure of the gospel, the identity of Jesus, the messianic secret, and the way of the cross.`,
  calloutTitle: `Take Up Your Cross and Follow`,
  calloutBody: `Mark presses every reader toward a decision about Jesus. The Son of Man came not to be served but to serve, and to give his life as a ransom for many &mdash; and he still goes ahead of us. The unfinished ending is an invitation: will we follow the crucified and risen Lord, and carry on the proclamation the women were too afraid to begin?`,
};
