...
export default function SermonOnTheMountGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_sotm_tab", "overview");
  const [beatOpen, setBeatOpen] = usePersistedState<string>("vine_sotm_beat", "");
  const [antOpen, setAntOpen] = usePersistedState<string>("vine_sotm_ant", "");
  const [pietyOpen, setPietyOpen] = usePersistedState<string>("vine_sotm_piety", "");
  const [journal, setJournal] = usePersistedState<string>("vine_sotm_journal", "");
