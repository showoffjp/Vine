...
export default function BookOfActsGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_acts_tab", "overview");
  const [openExp, setOpenExp] = usePersistedState<string>("vine_acts_exp", "");
  const [openPaul, setOpenPaul] = usePersistedState<string>("vine_acts_paul", "");
  const [journal, setJournal] = usePersistedState<string>("vine_acts_journal", "");
