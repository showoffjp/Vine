...
export default function ChristianBookOf2PeterGuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            Peter&rsquo;s farewell letter &mdash; growing in grace and the knowledge of Christ, confirming your calling, the trustworthy and Spirit-inspired word, a stern warning against false teachers, and the certain promise of the day of the Lord and the new heavens and new earth.
          </p>
        </header>
        ...
        {tab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of 2 Peter through visual teaching on the structure of the letter, growing in grace, and the promise of the day of the Lord.
            </p>
