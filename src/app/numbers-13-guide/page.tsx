...
export default function Numbers13GuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Numbers 13 through these video teachings on the twelve spies, the exploration of Canaan, the cluster of grapes from Eshcol, and the contrast between Caleb&rsquo;s courageous faith and the fear of the ten.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>We Are Well Able</h3>
