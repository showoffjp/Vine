...
const data: SectionGuideData = {
  ...
  intro: `The reluctant prophet who fled from God &mdash; the storm and the great fish, the astonishing repentance of Nineveh, Jonah&rsquo;s anger at God&rsquo;s mercy, and the scandalous question of God&rsquo;s compassion for all peoples, even our enemies.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Jonah through visual teaching on the structure of the book, the scandal of God&rsquo;s mercy toward enemies, and the sign of Jonah that points to the resurrection.`,
  calloutTitle: `The Question That Remains`,
  calloutBody: `Jonah ends not with an answer but with a question from God&rsquo;s own lips, and that question still searches every reader. It confronts our nationalism and our resistance to grace shown to enemies, and reveals a God who is gracious and merciful, slow to anger, abounding in steadfast love &mdash; whose heart is for all peoples. The unfinished story asks each of us: are we willing for God to be this merciful?`,
};
