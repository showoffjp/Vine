...
export default function TheodicyGuidePage() {
  const [tab, setTab] = useLocalStorage("vine_theod_tab", "overview");
  const [openType, setOpenType] = useLocalStorage("vine_theod_type", "");
  const [openTheod, setOpenTheod] = useLocalStorage("vine_theod_theod", "");
  const [journal, setJournal] = useLocalStorage("vine_theod_journal", "");
