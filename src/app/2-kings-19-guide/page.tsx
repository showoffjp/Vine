...
export default function SecondKings19GuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            Hezekiah seeks Isaiah and is told not to fear, spreads Sennacherib&rsquo;s threatening letter before the Lord and prays that the kingdoms of the earth may know God alone, and sees the angel of the Lord strike 185,000 in the Assyrian camp as Jerusalem is delivered.
          </p>
        </header>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of 2 Kings 19 through visual teaching on Hezekiah&rsquo;s turning to the prophet Isaiah, his model prayer spreading the letter before the Lord, the Lord&rsquo;s answer against Assyria&rsquo;s pride, and the dramatic overnight deliverance of Jerusalem.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>God Alone</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            2 Kings 19 shows the believer what to do with the letters of fear that arrive in the darkest hour: carry them into the presence of God and spread them open before him. Hezekiah prayed not first for his own safety but that &ldquo;all the kingdoms of the earth may know that you, O Lord, are God alone&rdquo; &mdash; and the God who was mocked answered in a single night, vindicated as the maker of heaven and earth.
          </p>
        </div>
      </main>
    </div>
