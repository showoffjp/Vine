...
const data: SectionGuideData = {
  ...
  intro: `Paul addresses food sacrificed to idols, teaching that &ldquo;knowledge puffs up, but love builds up.&rdquo; Though an idol is nothing and there is but one God, love must limit liberty for the sake of a weaker brother for whom Christ died.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Corinthians 8 through visual teaching on food offered to idols, the contrast between knowledge that puffs up and love that builds up, the confession of one God and one Lord, and the self-limiting love that guards a weaker brother.`,
  calloutTitle: `Love Limits Liberty`,
  calloutBody: `1 Corinthians 8 holds together right knowledge and self-giving love. Though an idol is nothing and there is but one God and one Lord, Paul insists that the strong must lay down their liberty rather than wound a brother for whom Christ died. True Christian freedom finds its fulfillment not in asserting our rights but in love.`,
};
