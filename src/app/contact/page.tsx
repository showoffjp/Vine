                  ...
                  {teamOptions.map((opt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-semibold group-hover:text-[#D4AF37] transition-colors" style={{ color: "#F2F2F8" }}>
                            {opt.title}
                          </p>
              ...
              >
                ...
                <div className="space-y-3 text-sm" style={{ color: "#6A6A88" }}>
                  <div className="flex items-start gap-2">
                    <MapPin size={14} className="mt-0.5 shrink-0" style={{ color: "#D4AF37" }} />
                    <span>Global — built for every believer, everywhere</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <Mail size={14} className="mt-0.5 shrink-0" style={{ color: "#D4AF37" }} />
                    <span>hello@vine.community</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <MessageSquare size={14} className="mt-0.5 shrink-0" style={{ color: "#D4AF37" }} />
