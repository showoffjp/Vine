...
export default function FirstKings12GuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of 1 Kings 12 through visual teaching on the tragic division of the kingdom at Shechem, the folly of Rehoboam who rejected the wise counsel of the elders for the harsh advice of his companions, the revolt of the northern tribes who cried &ldquo;To your tents, O Israel!&rdquo; and made Jeroboam king, and the counterfeit worship of the golden calves at Bethel and Dan that became the defining sin of the northern kingdom for generations.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>When Pride and Pragmatism Divide a People</h3>
