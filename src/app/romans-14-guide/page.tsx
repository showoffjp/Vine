...
const data: SectionGuideData = {
  ...
  title: `The Letter to the Romans, Chapter 14`,
  intro: `The strong and the weak in faith &mdash; Paul teaches a divided church to welcome one another without quarreling over disputable matters of food and days, to refuse the impulse to judge or despise a fellow servant of the Lord, and to let love limit liberty: &ldquo;The kingdom of God is not a matter of eating and drinking, but of righteousness, peace and joy in the Holy Spirit.&rdquo;`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Romans 14 through visual teaching on welcoming the weak in faith without quarreling, refusing to judge a fellow servant of the Lord, and letting love govern the use of Christian liberty so that the church is built up in righteousness, peace, and joy.`,
  calloutTitle: `Hold Liberty with Love`,
  calloutBody: `Romans 14 calls the people of God to live as servants of one Lord before whom every knee will bow &mdash; welcoming the weak without quarreling, refusing to judge or despise one another over disputable matters, and pursuing what leads to peace and mutual edification. Let the strong bear with the weak and the weak honor the strong, for everything that does not come from faith is sin, and love is greater than liberty.`,
};
