...
export default function SpiritualGiftsGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_sgifts_tab", "overview");
  const [listsOpen, setListsOpen] = usePersistedState<string>("vine_sgifts_lists", "");
  const [cessOpen, setCessOpen] = usePersistedState<string>("vine_sgifts_cess", "");
  const [journal, setJournal] = usePersistedState<string>("vine_sgifts_journal", "");
