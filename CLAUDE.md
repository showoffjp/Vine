...
- **PSALTER COMPLETE: all 150 psalms have study guides** (Batches 240-246 delivered the final 14 as PsalmGuideTemplate data wrappers). Now working through Job: 1-38 done (SectionGuideTemplate data wrappers, custom section tabs, force-dynamic layouts; 38 pre-existing); remaining Job ch: 39-42. Cycles 1-3 + interlude + final defense + ELIHU (32-37) COMPLETE (Job 19 "I know my Redeemer lives" = peak; Job 21 = empirical demolition of retribution; 22 Eliphaz invents sins; 23 "come out as gold"; 24 delayed justice; 25 Bildad's dwindling 6 verses; 26 "hangs the earth on nothing"; 27 oath of integrity + portion of the wicked; 28 hymn to wisdom "fear of the Lord that is wisdom"; 29 former days of honor; 30 "But now" humiliation + "you have turned cruel"; 31 great oath of clearance "covenant with my eyes", "words of Job are ended"). Elihu DONE (32 intro/anger, 33 "I have found a ransom" 33:24 = mediator/redemptive suffering, 34 God is just, 35 does piety profit + "songs in the night", 36 "delivers the afflicted by their affliction" 36:15, 37 storm hymn bridging to whirlwind). Next = God's speeches from the whirlwind: 39 (wild animals: mountain goats, wild donkey, ox, ostrich, horse "he laughs at fear", hawk/eagle), 40 (God challenges Job; Job's first repentance "I lay my hand on my mouth" 40:4; then Behemoth), 41 (Leviathan = climax of the whirlwind speeches, uncontrollable by man, only by God). 38 already exists. Then epilogue 42 (Job's full repentance "I had heard of you... but now my eye sees you" 42:5-6; God vindicates Job + rebukes friends 42:7-8; Job prays for them; restoration double). Keep God's speeches whole per batch. Keep speeches whole per batch. Friends-are-orthodox-but-wrong theme; God rebukes them 42:7. Pattern: SectionGuideTemplate with 5 section tabs (Overview + 3 content + Application), accent hex rotating GREEN/GOLD/TEAL/PURPLE/ROSE, calloutTitle/Body, wire BOTH TOPIC_SLUGS map AND ALL_TOPICS `{ label }` array in same commit
