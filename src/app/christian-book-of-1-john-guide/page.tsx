...
const data: SectionGuideData = {
  ...
  intro: `The epistle of assurance &mdash; God is light and God is love, walking in the light and confessing sin, the tests of genuine faith, and the confidence that those who believe in Christ may know they have eternal life.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 John through visual teaching on the structure of the letter, the truth that God is love, and the assurance of salvation it was written to give.`,
  calloutTitle: `That You May Know`,
  calloutBody: `1 John was written that believers might know they have eternal life. The God who is light and love has sent his Son as both advocate and atoning sacrifice, so that those who believe in Christ, walk in his light, and love one another may rest with confidence in him who is true.`,
};
