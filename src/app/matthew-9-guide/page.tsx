...
const data: SectionGuideData = {
  ...
  title: `The Gospel of Matthew, Chapter 9`,
  intro: `A gallery of mercy and authority &mdash; Jesus forgives and heals the paralytic, calls Matthew from the tax booth, teaches the parable of new wineskins, raises Jairus&rsquo; daughter and heals the bleeding woman, opens blind eyes, and looks on the harassed crowds with compassion: the harvest is plentiful, but the workers are few.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Matthew 9 through visual teaching on Jesus&rsquo; authority to forgive sins, the call of Matthew, the parable of new wineskins, and the compassion that sees a plentiful harvest.`,
  calloutTitle: `The Harvest is Plentiful`,
  calloutBody: `Matthew 9 shows the heart of Jesus in action &mdash; forgiving the guilty, calling the outcast, healing the broken, and raising the dead. Each miracle answers the question of who he is, and the chapter ends not in triumphant display but in tender compassion for sheep without a shepherd. Its enduring call still sounds: pray earnestly to the Lord of the harvest, and be among the laborers he sends into his field.`,
};
