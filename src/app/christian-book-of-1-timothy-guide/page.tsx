...
const data: SectionGuideData = {
  ...
  title: `The Book of 1 Timothy`,
  intro: `Paul&rsquo;s pastoral charge to his young protege &mdash; guarding sound doctrine against false teachers, ordering the church&rsquo;s worship and prayer, the qualifications for elders and deacons, godliness with contentment over the love of money, and the call to fight the good fight of faith.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Timothy through visual teaching on the structure of the letter, the qualifications for church leaders, and the call to godliness with contentment.`,
  calloutTitle: `Guard the Good Deposit`,
  calloutBody: `First Timothy remains the great handbook for healthy church life &mdash; sound doctrine that issues in love, worship marked by wide-hearted prayer, leaders proven in character, and a godliness joined to contentment that frees the heart from the love of money. Its closing charge still summons every believer: guard the deposit, set an example in word and life, and fight the good fight of faith.`,
};
