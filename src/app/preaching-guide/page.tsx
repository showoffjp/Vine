...
export default function PreachingGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_preach_tab", "overview");
  const [theolOpen, setTheolOpen] = usePersistedState<string>("vine_preach_theol", "");
  const [appOpen, setAppOpen] = usePersistedState<string>("vine_preach_app", "");
  const [journal, setJournal] = usePersistedState<string>("vine_preach_journal", "");
