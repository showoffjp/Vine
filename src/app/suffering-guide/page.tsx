...
export default function SufferingGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_suff_tab", "overview");
  const [purpOpen, setPurpOpen] = usePersistedState<string>("vine_suff_purp", "");
  const [jesusOpen, setJesusOpen] = usePersistedState<string>("vine_suff_jesus", "");
  const [journal, setJournal] = usePersistedState<string>("vine_suff_journal", "");
