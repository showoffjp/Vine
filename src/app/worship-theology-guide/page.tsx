...
export default function WorshipTheologyGuide() {
  const [tab, setTab] = useLocalStorage("vine_wship_tab", "overview");
  const [theolOpen, setTheolOpen] = useLocalStorage("vine_wship_theol", "");
  const [musicOpen, setMusicOpen] = useLocalStorage("vine_wship_music", "");
  const [journal, setJournal] = useLocalStorage("vine_wship_journal", "");
