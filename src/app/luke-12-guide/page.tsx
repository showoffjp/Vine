...
const data: SectionGuideData = {
  ...
  title: `The Gospel of Luke, Chapter 12`,
  intro: `A searching discourse on fear, possessions, providence, and readiness &mdash; Jesus warns against the leaven of hypocrisy and the fear of man, tells the Parable of the Rich Fool, calls his &ldquo;little flock&rdquo; to trust the Father who feeds the ravens and clothes the lilies, urges watchfulness for the Master&rsquo;s return, and speaks of the fire and division his gospel brings.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Luke 12 through visual teaching on the fear of God over the fear of man, the warning against covetousness in the Parable of the Rich Fool, the Father&rsquo;s tender providence over ravens and lilies, and the call to watchful readiness for the Master&rsquo;s return.`,
  calloutTitle: `Where Your Treasure Is`,
  calloutBody: `Luke 12 lays bare the divided heart and calls it home. Fear of man gives way to the fear of God, who numbers the sparrows and our very hairs; the greed of the rich fool gives way to being &ldquo;rich toward God&rdquo;; anxiety gives way to trust in the Father who clothes the lilies; and complacency gives way to lamps kept burning for the Master&rsquo;s return. &ldquo;Where your treasure is, there will your heart be also.&rdquo;`,
};
