...
export default function DoubtFaithGuide() {
  const [tab, setTab] = useLocalStorage("vine_doubt_tab", "overview");
  const [intOpen, setIntOpen] = useLocalStorage("vine_doubt_int", "");
  const [deconOpen, setDeconOpen] = useLocalStorage("vine_doubt_decon", "");
