...
const data: SectionGuideData = {
  ...
  badge: `Genesis Study`,
  title: `Genesis 42`,
  intro: `Driven by famine, Jacob sends ten sons to Egypt for grain while keeping Benjamin home. Joseph, now governor, recognizes his brothers, tests them as spies, holds Simeon hostage, and secretly returns their money &mdash; beginning the brothers&rsquo; long road to repentance and the family&rsquo;s reconciliation.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Genesis 42 through visual teaching on the famine that drives the brothers to Egypt, the fulfillment of Joseph&rsquo;s dreams, the awakening of long-buried conscience, and Jacob&rsquo;s grief as the providence of God moves toward reconciliation.`,
  calloutTitle: `Providence Working Through Suffering`,
  calloutBody: `Genesis 42 shows the deep providence of God working through famine, fear, and guilt toward reconciliation. The same testing that awakens the brothers&rsquo; consciences after twenty years is the hand of a God who is not thwarted by sin, but who patiently draws a broken family back toward repentance, restoration, and the salvation of many lives.`,
};
