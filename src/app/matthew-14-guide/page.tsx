...
const data: SectionGuideData = {
  ...
  title: `Matthew 14 Chapter Guide`,
  intro: `From the grief of John&rsquo;s beheading to five loaves feeding a multitude &mdash; and then Jesus walking across the sea in the fourth watch of the night &mdash; Matthew 14 is a chapter of miracles that discloses the compassion and power of the Son of God.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Matthew 14 through these video teachings on the death of John the Baptist, Jesus&rsquo;s compassion for the crowds, the feeding of the five thousand, Peter walking on water, and the disciples&rsquo; worship of the Son of God.`,
  calloutTitle: `Truly You Are the Son of God`,
  calloutBody: `Matthew 14 moves from political horror to miraculous provision to divine power over nature, building toward the disciples&rsquo; first full confession: &ldquo;Truly you are the Son of God.&rdquo; The chapter shows that Jesus&rsquo;s compassion is not defeated by grief, that what we bring to him in faith is never too little, and that when we begin to sink it is his hand that reaches out to catch us.`,
};
