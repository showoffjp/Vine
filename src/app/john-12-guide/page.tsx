...
const data: SectionGuideData = {
  ...
  title: `The Gospel of John, Chapter 12`,
  intro: `The hinge between Jesus&rsquo; public ministry and the Passion &mdash; Mary&rsquo;s extravagant anointing at Bethany, the Triumphal Entry into Jerusalem, the coming of the Greeks and the declaration that &ldquo;the hour has come,&rdquo; and John&rsquo;s solemn reflection on belief and unbelief.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of John 12 through visual teaching on Mary&rsquo;s anointing, the Triumphal Entry, the coming of the Greeks and the hour of glory, and John&rsquo;s reflection on belief and unbelief.`,
  calloutTitle: `Walk While You Have the Light`,
  calloutBody: `John 12 turns the corner from public ministry to the cross. In Mary&rsquo;s broken jar of perfume, the palm-strewn road into Jerusalem, the grain of wheat that must die, and Jesus&rsquo; final cry to believe in the light, the chapter sets before every reader the same decision the crowds faced: to love the glory of God more than the praise of men, and to walk in the light while it is still day.`,
};
