...
const data: SectionGuideData = {
  ...
  intro: `Jesus the Messiah, Son of David and Son of Abraham &mdash; the promised King whose lineage fulfills the Scriptures, whose Sermon on the Mount unveils the kingdom of heaven, whose parables and miracles reveal his authority, and whose death and resurrection send his people to make disciples of all nations.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Matthew through visual teaching on the lineage and birth of the King, the Sermon on the Mount, the parables of the kingdom of heaven, and the passion and resurrection of Jesus the Messiah.`,
  calloutTitle: `Make Disciples of All Nations`,
