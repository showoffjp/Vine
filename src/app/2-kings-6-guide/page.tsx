...
const data: SectionGuideData = {
  ...
  title: `2 Kings 6 Chapter Guide`,
  intro: `From a borrowed axe head sinking in the Jordan to a mountain blazing with horses and chariots of fire, 2 Kings 6 declares that those who are with us are more than those who are against us &mdash; the invisible army of heaven stands guard over those who belong to God.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 2 Kings 6 through these video teachings on Elisha&rsquo;s miracles, the heavenly army at Dothan, the prayer &ldquo;Open his eyes, Lord,&rdquo; the floating axe head, and the victory achieved through bread rather than the sword.`,
  calloutTitle: `Those Who Are With Us Are More`,
  calloutBody: `Second Kings 6 is a sustained meditation on the difference between what we see and what is real. A mountain that looks empty is full of the armies of God. An enemy army that surrounds you can be led to your capital by the prophet they came to capture. A military threat can be ended not by a battle but by a banquet. The God who opens eyes, floats iron, and fills mountains with fire is greater than any force arrayed against his people.`,
};
