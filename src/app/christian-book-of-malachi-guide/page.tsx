...
const data: SectionGuideData = {
  ...
  intro: `The final word of the Old Testament &mdash; God&rsquo;s declaration of love to a doubting people, his rebuke of corrupt worship and broken faith, the promise of the messenger who prepares the way, and the dawning of the sun of righteousness before four hundred years of silence give way to the Gospel.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Malachi through visual teaching on God&rsquo;s love for a doubting people, the rebuke of corrupt worship and broken faith, the messenger of the covenant, and the sun of righteousness who rises with healing in his wings.`,
  calloutTitle: `The Sun of Righteousness Shall Rise`,
  calloutBody: `Malachi closes the Old Testament by meeting a cynical, doubting people with the steadfast love of God, calling them back to wholehearted worship and faithful living. Its final promise of a messenger to prepare the way and a sun of righteousness rising with healing leans across four hundred years of silence to the coming of John the Baptist and of Christ &mdash; the dawn that the whole Old Testament had been waiting for.`,
};
