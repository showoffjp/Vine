...
export default function ChristianEthicsPage() {
  const [tab, setTab] = usePersistedState<string>("vine_ethics_tab", "overview");
  const [openFW, setOpenFW] = usePersistedState<string>("vine_ethics_fw", "");
  const [openHC, setOpenHC] = usePersistedState<string>("vine_ethics_hc", "");
  const [journal, setJournal] = usePersistedState<string>("vine_ethics_journal", "");
