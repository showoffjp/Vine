...
const data: SectionGuideData = {
  ...
  title: `Genesis 50 Chapter Guide`,
  intro: `Joseph forgives his brothers &mdash; the death and mourning of Jacob, the great procession to Machpelah, the brothers&rsquo; fear of revenge, and Joseph&rsquo;s declaration: &ldquo;You intended to harm me, but God intended it for good&rdquo; &mdash; and the bones preserved for the Promised Land.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Genesis 50 through these video teachings on Joseph&rsquo;s forgiveness, the providence of God, the death and burial of Jacob, and Joseph&rsquo;s dying faith in the promise of the land.`,
  calloutTitle: `You Intended Evil but God Intended Good`,
  calloutBody: `Genesis 50 closes the book of beginnings with the most compressed statement of divine providence in all of Scripture. Joseph&rsquo;s story &mdash; the pit, the slavery, the prison, the palace &mdash; teaches that no human evil lies outside the scope of God&rsquo;s sovereign purpose, and that God&rsquo;s intention toward his people is always good, even when the path runs through suffering. The coffin waiting in Egypt is faith&rsquo;s answer to the future: God will visit, and the bones will come home.`,
};
