...
export default function ChristianBookOfMicahGuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            The word of a prophet from Moresheth &mdash; judgment upon Samaria and Jerusalem, the rebuke of corrupt leaders and false prophets, the promise of a ruler from Bethlehem, the summons to do justice and love mercy, and the wonder of a God who casts our sins into the depths of the sea.
          </p>
        </header>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Micah through visual teaching on the coming judgment, the rebuke of corrupt leaders, the ruler from Bethlehem, and the call to do justice, love mercy, and walk humbly with God.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>Do Justice, Love Mercy, Walk Humbly</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            Micah holds together the severity and the tenderness of God &mdash; judgment upon the proud and the corrupt, yet a ruler promised from Bethlehem and a mercy that casts our sins into the depths of the sea. His enduring question still searches every heart: not how much religion we have, but whether we do justice, love mercy, and walk humbly with our God.
          </p>
        </div>
      </main>
    </div>
