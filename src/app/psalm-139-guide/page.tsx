...
const data: SectionGuideData = {
  ...
  badge: `Psalms Study`,
  title: `Psalm 139`,
  intro: `Fearfully and wonderfully made &mdash; David&rsquo;s soaring meditation on the God who searches and knows us completely, who is present in every height and depth, who knit us together in the womb, whose thoughts toward us outnumber the sand, and who leads the surrendered heart in the way everlasting.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Psalm 139 through visual teaching on the omniscience and omnipresence of God, the dignity of every human life, and the prayer that asks God to search and lead the heart.`,
  calloutTitle: `Known, and Loved`,
  calloutBody: `Psalm 139 answers the deepest fears of the human heart &mdash; that we are unseen, unwanted, alone, or without worth. To the anxious it says you are held; to the one in darkness it says he is there; to the one who feels like a mistake it says you are fearfully and wonderfully made. And to every soul it offers the same homecoming prayer: &ldquo;Search me, O God, and know my heart&hellip; and lead me in the way everlasting.&rdquo;`,
};
