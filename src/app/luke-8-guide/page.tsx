...
const data: SectionGuideData = {
  ...
  title: `The Gospel of Luke, Chapter 8`,
  intro: `A chapter that reveals the authority of Jesus over the human heart, the storm, the powers of darkness, chronic disease, and death &mdash; the Parable of the Sower, the calming of the lake, the deliverance of the Gerasene demoniac, and the intertwined healings of Jairus&rsquo; daughter and the bleeding woman.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Luke 8 through visual teaching on the Parable of the Sower, the calming of the storm, the deliverance of the Gerasene demoniac, and the healings of Jairus&rsquo; daughter and the bleeding woman.`,
  calloutTitle: `Consider Carefully How You Listen`,
  calloutBody: `Luke 8 holds together teaching and miracle to answer one question: who is this, and how will we respond to him? From the soils of the heart to the stilled storm, from Legion freed to a dead child raised, the chapter calls us to be good soil &mdash; to hear the word, retain it, and by persevering produce a crop, trusting the One who commands even the winds and the water.`,
};
