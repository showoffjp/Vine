...
const data: SectionGuideData = {
  ...
  intro: `The God who is slow to anger but great in power &mdash; the prophesied fall of Nineveh, capital of Assyria, the woe pronounced upon the bloody city, the comfort published to oppressed Judah by the feet of him who brings good news, and the perfect balance of God&rsquo;s justice and mercy.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Nahum through visual teaching on the character of God, the prophesied fall of Nineveh, the connection to Jonah, and the balance of divine justice and mercy in the Minor Prophets.`,
  calloutTitle: `A Stronghold in the Day of Trouble`,
  calloutBody: `Nahum refuses to let us tear apart what God holds together. The same Lord whose wrath breaks the rocks and topples the bloody city of Nineveh is a stronghold for all who take refuge in him. Slow to anger yet great in power, he is the God of perfect justice and perfect mercy &mdash; and his enduring call still sounds: flee from the storm of judgment to the shelter of his goodness, for the Lord is good.`,
};
