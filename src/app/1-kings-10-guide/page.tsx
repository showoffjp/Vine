...
const data: SectionGuideData = {
  ...
  title: `The First Book of Kings, Chapter 10`,
  intro: `The peak of Solomon&rsquo;s glory &mdash; the Queen of Sheba comes from the ends of the earth to test the king with hard questions and is left breathless, confessing &ldquo;the half was not told me.&rdquo; A catalog of staggering wealth follows: 666 talents of gold, the great ivory throne, golden shields, horses and chariots &mdash; splendor at its height, with the quiet seeds of decline already sown.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Kings 10 through visual teaching on the Queen of Sheba&rsquo;s journey to test Solomon&rsquo;s God-given wisdom, the breathtaking catalog of gold, ivory, and the great throne that marks the peak of his reign, and the quiet warning of Deuteronomy 17 that foreshadows the apostasy to come.`,
  calloutTitle: `Glory at Its Height`,
