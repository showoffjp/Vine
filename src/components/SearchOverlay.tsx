...
const quickLinks = [
  { icon: BookOpen, label: "Bible — John 3:16", type: "Scripture", color: "#D4AF37" },
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 40px 80px rgba(0,0,0,0.8), 0 0 0 1px rgba(212,175,55,0.05)",
        }}
      >
        {/* Input */}
            ...
            <>
              ...
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider" style={{ color: "#D4AF37" }}>Trending Now</span>
                </div>
                <div className="flex flex-wrap gap-2">
                  {trending.map((t) => (
                    <button key={t.label} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm transition-colors"
                      ...
                      onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(212,175,55,0.3)"; e.currentTarget.style.color = "#F2F2F8"; }}
