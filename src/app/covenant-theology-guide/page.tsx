...
export default function CovenantTheologyGuidePage() {
  const [tab, setTab] = useLocalStorage("vine_cov_tab", "overview");
  const [openCov, setOpenCov] = useLocalStorage("vine_cov_grace", "");
  const [openBib, setOpenBib] = useLocalStorage("vine_cov_bib", "");
  const [journal, setJournal] = useLocalStorage("vine_cov_journal", "");
