...
export default function Acts18GuidePage() {
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Acts 18 through visual teaching on Paul&rsquo;s ministry in Corinth, the partnership of Aquila and Priscilla, the ruling of Gallio that shielded the Christian mission, and the gentle, private discipleship that equipped Apollos for a powerful public ministry.
            </p>
