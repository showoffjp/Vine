...
const data: SectionGuideData = {
  ...
  title: `Luke 10 &mdash; The Good Samaritan and Mary and Martha`,
  intro: `Mission, mercy, and devotion &mdash; the sending of the seventy, the parable of the Good Samaritan who redefines neighborly love, and Mary&rsquo;s choice of the &ldquo;one thing necessary&rdquo; at the feet of Jesus.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  calloutTitle: `Go and Do Likewise &mdash; and First, Sit and Listen`,
  calloutBody: `Luke 10 holds together the call to go and the call to stay &mdash; to go as harvest workers into the world, to act as neighbors to the broken, and to sit at the feet of Jesus and choose the one thing necessary. These three postures are not competing; they are the integrated shape of the life that follows him.`,
};
