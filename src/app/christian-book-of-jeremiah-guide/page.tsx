...
const data: SectionGuideData = {
  ...
  intro: `The weeping prophet&rsquo;s witness through the fall of Judah &mdash; the call of Jeremiah, his prophecies of judgment and exile, the suffering of a faithful messenger, the promise of the new covenant, and hope beyond destruction.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Jeremiah through visual teaching on the structure of the book, the promise of the new covenant, and the life of the weeping prophet.`,
  calloutTitle: `New Every Morning`,
  calloutBody: `Jeremiah teaches us that faithfulness is measured not by popularity but by perseverance, and that beyond every judgment stands a God whose steadfast love never ceases. Even in exile his mercies are new every morning &mdash; and his new covenant, written on the heart and sealed in Christ, is the surest hope beyond every destruction.`,
};
