...
export default function Luke15GuidePage() {
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Luke 15 through visual teaching on the welcome of sinners, the lost sheep and the lost coin, the prodigal son and his running Father, and the warning of the elder brother left outside the feast.
            </p>
