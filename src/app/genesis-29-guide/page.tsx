...
const data: SectionGuideData = {
  ...
  badge: `Genesis Study`,
  title: `Genesis 29`,
  intro: `Jacob arrives in Paddan-aram, meets Rachel at the well, and is welcomed by Laban &mdash; only to be deceived into marrying Leah. The deceiver is now deceived, yet through the unloved Leah&rsquo;s sons God begins to build the tribes of Israel and the line that leads to Christ.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Genesis 29 through visual teaching on the providential meeting at the well, the irony of the deceiver deceived, the Lord&rsquo;s tender care for the unloved Leah, and the birth of the tribes of Israel.`,
  calloutTitle: `Grace for the Overlooked and the Afflicted`,
  calloutBody: `Genesis 29 holds together the seriousness of human sin and the patient sovereignty of God. The same chapter that shows Laban&rsquo;s treachery and a bitter rivalry also shows a God who sees the unloved, hears the afflicted, and weaves the line of redemption &mdash; through Levi&rsquo;s priesthood and Judah&rsquo;s royal line &mdash; right through Leah&rsquo;s tears toward Christ.`,
};
