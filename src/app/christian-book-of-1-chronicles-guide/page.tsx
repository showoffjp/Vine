...
const data: SectionGuideData = {
  ...
  title: `The Book of 1 Chronicles`,
  intro: `The story of God&rsquo;s faithfulness retold for a people returned from exile &mdash; the sweeping genealogies from Adam, the reign of David seen through a priestly lens, the bringing up of the ark to Jerusalem, the everlasting covenant with David, and the great preparations for the temple Solomon would build.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Chronicles through visual teaching on the genealogies of God&rsquo;s faithfulness, the reign of David, the bringing up of the ark, the everlasting covenant, and the preparations for the temple.`,
  calloutTitle: `Of Your Own Have We Given You`,
  calloutBody: `1 Chronicles gathers the scattered names of history into one great testimony of God&rsquo;s faithfulness, and crowns it with the promise of an everlasting throne in the line of David &mdash; fulfilled in Christ. Its enduring call still sounds: to set worship at the center of our lives and to give to God, with a whole heart, out of all that he has first given to us.`,
};
