...
const data: SectionGuideData = {
  ...
  intro: `Truth lived out in hospitality and humility &mdash; the elder writes to beloved Gaius, rejoicing that he walks in the truth, commending his support of traveling missionaries for the sake of the Name, exposing the proud ambition of Diotrephes, and urging the church to imitate good and not evil.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 3 John through visual teaching on the letters of John, the practice of Christian hospitality, the support of gospel missionaries, and the contrast between Gaius, Diotrephes, and Demetrius.`,
  calloutTitle: `Imitate Good, Not Evil`,
  calloutBody: `3 John is the shortest book in the Bible, yet it shows the truth taking flesh in everyday life. In Gaius we see faithful hospitality; in Diotrephes the ruin of pride; in Demetrius a life of good testimony. The closing call still rings clear: do not imitate evil but imitate good, for whoever does good is from God &mdash; and may peace be upon all who walk in the truth.`,
};
