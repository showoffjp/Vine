...
export default function EphesiansGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_eph_tab", "overview");
  const [openBless, setOpenBless] = usePersistedState<string>("vine_eph_bless", "");
  const [openWalk, setOpenWalk] = usePersistedState<string>("vine_eph_walk", "");
  const [journal, setJournal] = usePersistedState<string>("vine_eph_journal", "");
