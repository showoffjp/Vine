            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  gap: 8,
                  background: "linear-gradient(135deg, rgba(58,125,86,0.15), rgba(107,79,187,0.1))",
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: 220,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(58,125,86,0.06) 0%, transparent 70%)",
                    pointerEvents: "none",
                  }}
                />
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                  <div>
                    <div style={{ fontSize: 11, color: "#3a7d56", fontWeight: 600, textTransform: "uppercase", letterSpacing: 0.7, marginBottom: 6 }}>
                      Active Plan
                    </div>
                  ...
                  <div style={{ position: "relative", flexShrink: 0 }}>
                    ...
                    >
                      <div style={{ fontSize: 22, fontWeight: 800, color: "#3a7d56" }}>{progress}%</div>
              ...
              >
                ...
                {[
                  ...
                  >
                    ...
                    <div style={{ fontSize: 24, fontWeight: 800, color: "#3a7d56" }}>{stat.value}</div>
                  </div>
                ))}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 8 }}>
                {weekDays.map((day) => (
                  <div
                    key={day.label}
                    style={{
                      background: day.today ? "rgba(58,125,86,0.07)" : "#07070F",
                      border: day.today ? "1px solid rgba(58,125,86,0.5)" : "1px solid #1E1E32",
                      borderRadius: 12,
                      padding: "12px 8px",
                      textAlign: "center",
                  ...
                  >
                    <div style={{ fontSize: 11, color: day.today ? "#3a7d56" : "#6A6A88", fontWeight: 600, marginBottom: 6 }}>
                      {day.label}
                    </div>
                          ...
                          >
                            ...
                            <div style={{ width: 28, display: "flex", justifyContent: "center", flexShrink: 0 }}>
                              {isDone ? (
                                ...
                                >
                                  <Check size={13} style={{ color: "#3a7d56" }} />
                                </div>
                              ) : isToday ? (
                                <div
                                  style={{
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              <div
                                style={{
                                  ...
                                  color: isDone ? "#6A6A88" : isToday ? "#3a7d56" : "#F2F2F8",
                            ...
                            <button type="button"
                              ...
                              style={{
                                ...
                                border: isDone
                                  ? "1px solid rgba(58,125,86,0.2)"
                                  : isToday
                                  ? "1px solid rgba(58,125,86,0.4)"
                                  : "1px solid #1E1E32",
                                borderRadius: 8,
                                color: isDone ? "#3a7d56" : "#8A8AA8",
                                fontSize: 12,
                                fontWeight: 600,
                                padding: "5px 12px",
                                cursor: "pointer",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14 }}>
                {ALT_PLANS.map((plan) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(58,125,86,0.3)";
                    }}
                    onMouseLeave={(e) => {
