...
const data: SectionGuideData = {
  ...
  title: `The Book of 2 Chronicles`,
  intro: `The story of Judah from glory to exile and hope &mdash; Solomon building and dedicating the temple as the glory of God descends, the dividing of the kingdom, the faithful reformer kings who sought the Lord, the great revivals and Passovers, and the fall of Jerusalem closing with the decree of Cyrus that opened the way home.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 2 Chronicles through visual teaching on Solomon&rsquo;s temple and the glory of God, the kings of Judah, the great revivals and reforms, and the fall of Jerusalem with its closing hope of return.`,
  calloutTitle: `If My People Will Humble Themselves`,
  calloutBody: `2 Chronicles traces Judah from the glory of the temple to the ashes of exile, yet it never loses sight of God&rsquo;s steadfast love. Its enduring call still sounds: &ldquo;If my people who are called by my name humble themselves, and pray and seek my face&hellip; then I will hear from heaven and will forgive their sin and heal their land.&rdquo; The book ends not in despair but with the way home flung open &mdash; a hope fulfilled at last in Jesus Christ, the Son of David.`,
};
