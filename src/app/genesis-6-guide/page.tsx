...
const data: SectionGuideData = {
  ...
  title: `Genesis 6 Chapter Guide`,
  intro: `The corruption of the earth, the grief of God, and the grace shown to Noah &mdash; Genesis 6 reveals a world saturated with evil, a Creator grieved to his heart, and one man who found favor in the eyes of the Lord and was called to build the ark that would preserve life through the coming flood.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Genesis 6 through these video teachings on the sons of God and daughters of men, the Nephilim, Noah&rsquo;s righteousness, the coming flood, and God&rsquo;s covenant of preservation.`,
  calloutTitle: `Noah Did All That God Commanded`,
  calloutBody: `Genesis 6 confronts us with the seriousness of sin, the grief of a holy God, and the extraordinary grace extended to one man who walked with God when no one else did. The ark Noah built was more than a boat &mdash; it was a monument of faith, a visible sermon preached to a corrupt generation, and a type of the greater salvation God would accomplish through his Son. As in Noah&rsquo;s day, the call remains: walk with God, trust his word, and do all that he commands.`,
};
