...
const data: SectionGuideData = {
  ...
  intro: `From Sinai to the plains of Moab &mdash; the ordering of Israel around God&rsquo;s presence, the repeated grumbling in the wilderness, the failure of the twelve spies at Kadesh-barnea, the forty years of wandering, the strange blessing of Balaam, and a new generation poised at last to enter the Promised Land.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Numbers through visual teaching on the ordering of the camp, the rebellions in the wilderness, the failure at Kadesh-barnea, and the new generation poised to enter the land.`,
  calloutTitle: `Faithful When We Are Faithless`,
  calloutBody: `Numbers is a sober warning against unbelief and grumbling &mdash; a whole generation forfeited the land they were given because they would not trust the God who redeemed them. Yet it is finally a book of hope, for the God who is faithful when his people are faithless carries his promise across the wilderness and brings a new generation to the very edge of the Promised Land.`,
};
