...
export default function ChristianBookOfHoseaGuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Hosea through visual teaching on the structure of the book, the living parable of Hosea and Gomer, and the relentless, redeeming love of God for his unfaithful people.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>Love That Will Not Let Go</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            Hosea remains the great parable of grace &mdash; a faithful God pursuing a faithless people, buying them back at cost, and refusing to surrender them to the consequences they deserved. Its message still calls every wandering heart home: return to the LORD, for he heals our waywardness and loves us freely.
          </p>
        </div>
      </main>
    </div>
