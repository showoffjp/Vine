...
export default function Luke9GuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Luke 9 through visual teaching on the feeding of the five thousand, Peter&rsquo;s confession and the daily cross, the Transfiguration, and the bracing cost of following Christ toward Jerusalem.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>Setting His Face Toward Jerusalem</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            Luke 9 is the great hinge of the Gospel. The mighty works of Galilee reach their height in the feeding of the multitude and the glory of the mountain, yet at the heart of it all stands the question, &ldquo;Who do you say that I am?&rdquo; and the answer that the Christ of God must suffer. From here the road bends toward Jerusalem and the cross, and the call sounds out to take up that cross daily and follow without looking back.
          </p>
        </div>
      </main>
    </div>
