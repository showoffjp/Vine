        ...
        >
          ...
          <h1
            style={{
              ...
              lineHeight: 1.0,
              marginBottom: "24px",
              background: "linear-gradient(135deg, #3a7d56 0%, #52a876 40%, #3a7d56 100%)",
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px 100px" }}>
            ...
            >
              <div
                style={{
                  ...
                  height: "320px",
                  background:
                    "radial-gradient(circle, rgba(58,125,86,0.06) 0%, transparent 70%)",
                  pointerEvents: "none",
                }}
              />
              <p
          ...
          <section style={{ marginBottom: "80px" }}>
            <div
              style={{
                background:
                  "linear-gradient(135deg, rgba(58,125,86,0.10) 0%, rgba(107,79,187,0.08) 100%)",
            ...
            >
              <div
                style={{
                  ...
                  height: "320px",
                  background:
                    "radial-gradient(ellipse, rgba(58,125,86,0.07) 0%, transparent 65%)",
                  pointerEvents: "none",
                }}
              />
              <h2
