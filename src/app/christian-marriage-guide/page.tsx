...
export default function ChristianMarriageGuide() {
  const [tab, setTab] = useLocalStorage("vine_marr_tab", "overview");
  const [rolesOpen, setRolesOpen] = useLocalStorage("vine_marr_roles", "");
  const [journal, setJournal] = useLocalStorage("vine_marr_journal", "");
