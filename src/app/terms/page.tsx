        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            >
              <p className="text-sm leading-relaxed" style={{ color: "#C0C0D8" }}>
                <strong style={{ color: "#3a7d56" }}>The short version:</strong> Be kind, be honest, don&apos;t misuse the platform, and remember that the AI companion is a tool — not a pastor. We reserve the right to remove content or accounts that harm the community.
              </p>
            </div>
          </div>
          ...
          >
            <p className="text-sm" style={{ color: "#6A6A88" }}>
              Questions? Contact{" "}
              <a href="mailto:legal@vine.community" style={{ color: "#3a7d56" }}>
