...
const data: SectionGuideData = {
  ...
  intro: `The fear of the Lord as the beginning of wisdom &mdash; the two paths of wisdom and folly, wisdom personified at creation, practical wisdom for speech, money, work and relationships, and how Proverbs points to Christ the wisdom of God.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Proverbs through visual teaching on the structure of the book, the fear of the Lord as the beginning of wisdom, and the wisdom literature of the Bible.`,
  calloutTitle: `Begin with the Fear of the Lord`,
  calloutBody: `Proverbs invites every reader to pursue wisdom as hidden treasure, beginning in reverent awe before God and ending in the One who is the wisdom of God incarnate. To fear the Lord and to follow Christ is to walk the path that grows brighter and brighter until full day.`,
};
