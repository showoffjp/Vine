...
const data: SectionGuideData = {
  ...
  intro: `The thunderous word of a shepherd from Tekoa &mdash; God&rsquo;s judgment on the nations and on Israel, a fierce cry against injustice and empty religion, the five visions of judgment, and the closing promise to restore the fallen tent of David.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Amos through visual teaching on the shepherd prophet, his oracles against the nations, his cry for justice to roll down like waters, and the closing promise of restoration.`,
  calloutTitle: `Let Justice Roll Down Like Waters`,
  calloutBody: `Amos confronts every age with the truth that God will not accept worship from hands that oppress the poor. Yet the lion that roars in judgment is also the Lord who promises to raise up the fallen tent of David &mdash; a hope fulfilled in Christ, in whom mercy has the last word.`,
};
