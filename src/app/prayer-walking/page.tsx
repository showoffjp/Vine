...
const PW_VIDEOS = [
  { videoId: "rtkS_8VWfB0", title: "Prayer Walking — An Introduction", channel: "Gospel in Life", description: "The spiritual discipline of praying over physical places and how it reshapes both prayer and mission." },
  { videoId: "ej_6dVdJSIU", title: "Praying for Your City", channel: "Ligonier Ministries", description: "A biblical case for intercession for your neighborhood, city, and community — and how to do it consistently." },
  { videoId: "4Eg_di-O8nM", title: "Walk and Pray — The Practice of Prayer Walking", channel: "Desiring God", description: "Practical guidance for making prayer walking a regular spiritual discipline." },
  { videoId: "gV9JugO_5Mk", title: "Neighborhood Prayer — Loving Your Community Through Prayer", channel: "The Gospel Coalition", description: "How to pray for the people on your street, in your apartment building, and throughout your neighborhood." },
];
            ...
            <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 26 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
                {route.stops.map((stop, i) => {
                  ...
                  return (
                    <div role="button" tabIndex={0} key={i} onClick={() => setCompletedStops(prev => { const n = new Set(prev); if (done) { n.delete(key); } else { n.add(key); } return n; })}
