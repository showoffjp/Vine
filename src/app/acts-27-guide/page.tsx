...
const data: SectionGuideData = {
  ...
  title: `The Acts of the Apostles, Chapter 27`,
  intro: `Paul&rsquo;s dramatic sea voyage toward Rome carries him from Caesarea past Crete into the grip of a violent northeaster called Euroclydon. When all hope is abandoned, an angel assures him that no life will be lost, only the ship, and the prisoner becomes the true leader aboard. The vessel runs aground and breaks apart, yet all 276 souls reach the shore of Malta safely &mdash; God&rsquo;s promise fulfilled to the letter.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Acts 27 through visual teaching on Paul&rsquo;s voyage from Caesarea and the warning he gave at Fair Havens, the violent northeaster that drove the ship and the angel&rsquo;s promise in the night, the apostle&rsquo;s steadying faith and leadership amid the storm, and the shipwreck at Malta that brought all 276 souls safely to land.`,
  calloutTitle: `The Providence of God in the Storm`,
  calloutBody: `Acts 27 is a stirring testimony to the faithfulness of God in the midst of overwhelming peril. Human counsel falters, the elements rage, and every natural hope fails &mdash; yet the word of the Lord stands sure. Paul, a prisoner in chains, becomes the true leader aboard the ship, steadying frightened men by his unwavering trust in God. The promise given to him is fulfilled to the letter: not one life is lost, and all 276 are brought safely to land.`,
};
