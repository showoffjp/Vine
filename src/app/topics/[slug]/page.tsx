...
const topics: Record<string, Topic> = {
  ...
  "resurrection": {
    ...
    relatedTopics: ["christian-ai-ethics", "deconstruction", "prayer-fasting", "genz-church"],
    discussions: [
      {
      ...
      {
        title: "Why do we celebrate Easter once a year when the resurrection is supposed to change everything?",
        author: "Marcus Webb",
        avatar: "MW",
        avatarColor: "#6B4FBB",
        hub: "r/TheologyAndDoctrine",
        hubColor: "#6B4FBB",
        upvotes: 1893,
        replies: 312,
        time: "4 days ago",
      ...
      {
        title: "My atheist friend asked me to explain the resurrection without using the Bible. How would you do it?",
        author: "Kwame Asante",
        avatar: "KA",
        avatarColor: "#F59E0B",
        hub: "r/Apologetics",
      ...
      {
        title: "The resurrection in Paul vs. the Gospels — contradictions or complementary accounts?",
        author: "Lydia Böhm",
        avatar: "LB",
        avatarColor: "#6B4FBB",
        hub: "r/BiblicalStudies",
        hubColor: "#6B4FBB",
        upvotes: 1247,
        replies: 231,
        time: "1 week ago",
  ...
  "biblical-finance": {
    name: "#BiblicalFinance",
    color: "#10B981",
    posts: "2.9k",
    description:
      "Stewardship, tithing, debt freedom, and building generational wealth — all through the lens of Scripture. Because Jesus talked about money more than heaven and hell combined.",
    scripture: "Matthew 6:24",
    relatedTopics: ["prayer-fasting", "mental-health-god", "marriage-faith", "genz-church"],
    discussions: [
      {
        title: "Is tithing still required for Christians? I've heard both sides — what does Scripture actually say?",
      ...
      {
        title: "$60K in credit card debt. I'm a Christian. How do I start?",
        author: "David Chen",
        avatar: "DC",
        avatarColor: "#3B82F6",
        hub: "r/FaithAndFinance",
        hubColor: "#10B981",
        upvotes: 2891,
        replies: 412,
        time: "3 days ago",
      ...
      {
        title: "Prosperity gospel vs. faithfulness theology — what's the actual difference?",
      ...
      {
        title: "I started giving 10% when I was barely making rent. Here's what happened over 5 years.",
        author: "Naomi Park",
        avatar: "NP",
        avatarColor: "#EC4899",
        hub: "r/FaithAndFinance",
  ...
  "biblical-manhood": {
    name: "#BiblicalManhood",
    color: "#F59E0B",
    posts: "1.9k",
    description:
      "Defining Christlike masculinity in a cultural moment of confusion. Not hypermasculinity, not erasure — but the radical, servant-hearted, courageous manhood that Jesus modeled.",
    scripture: "Ephesians 5:25",
    relatedTopics: ["marriage-faith", "genz-church", "mental-health-god", "deconstruction"],
    discussions: [
      {
      ...
      {
        title: "Men's mental health in the church — why are we still so silent about this?",
        author: "Samuel Mwangi",
        avatar: "SM",
        avatarColor: "#3B82F6",
        hub: "r/MenOfFaith",
      ...
      {
        title: "My father was absent. How do I model 'biblical manhood' when I never had one modeled for me?",
        author: "Anonymous",
        avatar: "AN",
        avatarColor: "#8A8AA8",
        hub: "r/MenOfFaith",
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-3 ml-auto">
                        ...
                        <button aria-label="Comment" type="button" className="flex items-center gap-1 text-xs" style={{ color: "#6A6A88" }}>
