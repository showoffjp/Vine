...
export default function ImageOfGodGuidePage() {
  const [tab, setTab] = usePersistedState<string>("vine_img_tab", "overview");
  const [openView, setOpenView] = usePersistedState<string>("vine_img_view", "");
  const [journal, setJournal] = usePersistedState<string>("vine_img_journal", "");
