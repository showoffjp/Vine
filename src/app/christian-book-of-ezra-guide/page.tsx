...
const data: SectionGuideData = {
  ...
  intro: `The return from exile and the restoration of God&rsquo;s people &mdash; the decree of Cyrus, the first return under Zerubbabel, the rebuilding of the temple amid fierce opposition, the coming of Ezra the scribe with a second wave, and the painful renewal of the covenant in devotion to the Law of the Lord.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Ezra through visual teaching on the decree of Cyrus, the return from exile, the rebuilding of the temple amid opposition, and the ministry of Ezra the scribe in renewing the covenant.`,
  calloutTitle: `The Hand of God Upon His People`,
  calloutBody: `Ezra tells the story of a faithful God keeping his word, stirring the heart of a pagan king and a scattered remnant to rebuild both the temple and the people around the Law of the Lord. Its enduring call is the very pattern of Ezra&rsquo;s own life &mdash; to set our hearts to study the Word, to do it, and to teach it &mdash; trusting that the good hand of God is upon all who seek him.`,
};
