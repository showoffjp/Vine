...
export default function GraceTheologyGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_grace_tab", "overview");
  const [openTulip, setOpenTulip] = usePersistedState<string>("vine_grace_tulip", "");
  const [openFw, setOpenFw] = usePersistedState<string>("vine_grace_fw", "");
  const [journal, setJournal] = usePersistedState<string>("vine_grace_journal", "");
