...
const data: SectionGuideData = {
  ...
  title: `Acts 16 &mdash; The Philippian Mission`,
  intro: `The Macedonian vision calling the gospel into Europe, Lydia of Thyatira whose heart the Lord opened by the riverside, Paul and Silas praying and singing at midnight in chains, and the Philippian jailer who asked &ldquo;What must I do to be saved?&rdquo; and believed with his whole household.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Acts 16 through visual teaching on the Macedonian call, Lydia&rsquo;s conversion, Paul and Silas in prison, and the Philippian jailer&rsquo;s faith.`,
  calloutTitle: `Come Over and Help Us`,
  calloutBody: `Acts 16 shows the gospel advancing not by human strategy alone but by the Spirit&rsquo;s sovereign direction &mdash; through closed doors, a vision in the night, an open heart by a river, a midnight earthquake, and a broken jailer asking the greatest question any soul can ask. God saves entire households, and he uses willing servants who will follow when he calls them across the water.`,
};
