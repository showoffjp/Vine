...
const data: SectionGuideData = {
  ...
  title: `Romans 3 Chapter Guide`,
  intro: `No one is righteous &mdash; not even one &mdash; yet God&rsquo;s righteousness is freely given through faith in Jesus Christ. Romans 3 diagnoses the universal human condition of sin and unveils the glorious remedy: justification by grace alone, through faith alone, in Christ alone.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Romans 3 through these video teachings on the universal reach of sin, the righteousness of God revealed in the gospel, propitiation through Christ&rsquo;s blood, and justification by faith alone.`,
  calloutTitle: `Just and the Justifier`,
  calloutBody: `Romans 3 drives every human being to the same humbling conclusion: all have sinned and fall short of the glory of God. Yet it is precisely there, at the bottom of human possibility, that the gospel shines most brightly &mdash; God is both just and the justifier of the one who has faith in Jesus. The righteousness we could never achieve has been freely given. Receive it by faith.`,
};
