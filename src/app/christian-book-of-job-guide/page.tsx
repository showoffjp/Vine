...
const data: SectionGuideData = {
  ...
  intro: `Wisdom literature&rsquo;s boldest wrestling with innocent suffering &mdash; the heavenly wager, the failure of Job&rsquo;s friends, his honest lament and longing for a Redeemer, the whirlwind speeches of God, and what faith can rest upon when no explanation is given.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Job through visual teaching on the structure of the book, the problem of innocent suffering, and God&rsquo;s answer from the whirlwind.`,
  calloutTitle: `Trust in the Mystery`,
  calloutBody: `Job does not hand us a solution to suffering; it gives us something deeper &mdash; permission to lament honestly, and a vision of a God whose wisdom and power can be trusted even when no explanation is given. Faith here learns to rest not on a reason, but on the One who answers from the whirlwind.`,
};
