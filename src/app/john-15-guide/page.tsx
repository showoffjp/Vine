...
const data: SectionGuideData = {
  ...
  intro: `The very heart of the Vine &mdash; Jesus as the true vine and the Father as the vinedresser, the call to abide in him and bear much fruit, the humbling truth that apart from him we can do nothing, the command to love one another as he has loved us, and the dignity of being chosen and appointed by Christ himself.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of John 15 through visual teaching on the true vine, the call to abide in Christ, the dependence of the branches, and the command to love one another.`,
  calloutTitle: `Abide in Me, and I in You`,
  calloutBody: `John 15 is the beating heart of the Vine. Here Jesus calls every believer not first to strive but to remain &mdash; to abide in him as a branch abides in the vine, drawing its whole life from his. Apart from him we can do nothing; joined to him we bear much fruit, love one another, and bring glory to the Father. This is the invitation that gives this whole site its name: come, abide, and let his life bear fruit in you.`,
};
