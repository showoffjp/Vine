...
export default function DiscipleshipGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_discip_tab", "overview");
  const [theolOpen, setTheolOpen] = usePersistedState<string>("vine_discip_theol", "");
  const [costOpen, setCostOpen] = usePersistedState<string>("vine_discip_cost", "");
  const [multOpen, setMultOpen] = usePersistedState<string>("vine_discip_mult", "");
  const [journal, setJournal] = usePersistedState<string>("vine_discip_journal", "");
