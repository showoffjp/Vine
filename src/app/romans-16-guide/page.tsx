...
export default function Romans16GuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Romans 16 through visual teaching on the commendation of Phoebe and the long roll call of named saints, the courage and partnership that carried the gospel forward, the sober warning against those who cause divisions by smooth talk, and the towering doxology that gathers up the whole theology of Romans into glory to the only wise God through Jesus Christ.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>To the Only Wise God</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            Romans 16 shows the gospel made flesh in a community of named and beloved saints &mdash; deacons and patrons, coworkers and hosts, the courageous and the hard-laboring &mdash; guarded against division and crowned with worship. The God of peace will soon crush Satan under your feet, and to the only wise God be glory forevermore through Jesus Christ. Amen.
          </p>
        </div>
      </main>
    </div>
