...
const spotlights = [
  ...
  {
    name: "Samuel & Amara Osei",
    flag: "🇬🇭",
    location: "Northern Ghana",
    avatar: "SO",
    color: "#F59E0B",
    role: "Medical missionaries",
    summary: "Running a mobile clinic serving 18 villages — pairing medical care with the Gospel.",
    update: "Opened our first permanent clinic building last month. 3,200 patient visits this year. 94 baptisms.",
  },
  {
    name: "Elena Vasquez",
    flag: "🇲🇽",
    ...
    avatar: "EV",
    color: "#10B981",
    role: "Indigenous church planter",
    summary: "Planting churches among Zapotec communities — in the Zapotec language.",
    update: "Seven house churches running. Recording audio Scripture in Zapotec this fall for communities that can't read.",
  },
  {
    name: "David & Ruth Nkemdirim",
    flag: "🇳🇬",
    location: "Kano State, Nigeria",
    avatar: "DN",
    color: "#3B82F6",
    role: "Evangelists & discipleship trainers",
    summary: "Training local believers to share their faith across the Muslim-majority north.",
    update: "Our DBS (Discovery Bible Study) model has spread to 23 communities without us. That's the multiplication we prayed for.",
  },
  {
    name: "Priya & Thomas George",
    flag: "🇮🇳",
    location: "Rajasthan, India",
    avatar: "PG",
    color: "#EC4899",
    role: "Slum community workers",
    summary: "Running literacy programs, women's empowerment, and church planting in five slum communities.",
    update: "The women's group led three of their neighbors to Christ this month. They are the missionaries now.",
  },
  {
    name: "Lars & Sofia Andersson",
    flag: "🇸🇪",
    location: "Kyrgyzstan",
    avatar: "LA",
    color: "#8B5CF6",
    role: "Business as mission",
    summary: "Running a coffee business as a platform for discipleship and meeting seekers.",
    update: "Our café has become a safe space for Muslims to ask spiritual questions. Nine baptized this year in private ceremonies.",
  },
];
