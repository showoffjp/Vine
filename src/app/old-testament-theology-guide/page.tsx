...
export default function OldTestamentTheologyGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_ottheol_tab", "overview");
  const [covOpen, setCovOpen] = usePersistedState<string>("vine_ottheol_cov", "");
  const [journal, setJournal] = usePersistedState<string>("vine_ottheol_journal", "");
