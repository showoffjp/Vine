...
const data: SectionGuideData = {
  ...
  title: `John 11: The Raising of Lazarus`,
  intro: `The deepest of Jesus&rsquo; signs &mdash; the illness and death of Lazarus, the delay that tested faith, the great confession of Martha, the tears of God at a grave, the cry that emptied a tomb, and the plot that turned the gift of life into the road to the cross. &ldquo;I am the resurrection and the life.&rdquo;`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of John 11 through visual teaching on the raising of Lazarus, the great &ldquo;I am the resurrection and the life&rdquo; saying, the tears of Jesus, and the hope of resurrection in the face of grief.`,
  calloutTitle: `I Am the Resurrection and the Life`,
  calloutBody: `John 11 meets us where grief is rawest &mdash; at the graveside, in the silence of a delay we do not understand. There Jesus does not offer a doctrine only but himself, weeping with us and yet calling the dead by name. For everyone who has stood at a tomb and whispered &ldquo;if only you had been here,&rdquo; his question still waits for an answer: &ldquo;I am the resurrection and the life&hellip; Do you believe this?&rdquo;`,
};
