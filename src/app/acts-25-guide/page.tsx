...
const data: SectionGuideData = {
  ...
  badge: `Acts Study`,
  title: `Acts 25`,
  intro: `Festus inherits Paul&rsquo;s case and resists a plot to ambush him, the trial at Caesarea ends with Paul&rsquo;s momentous appeal to Caesar, and Festus lays the puzzling case before King Agrippa and Bernice as the stage is set for Paul to testify before kings.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Acts 25 through visual teaching on the foiled plot against Paul, his decisive appeal to Caesar as a Roman citizen, and the grand hearing before King Agrippa and Bernice that sets the stage for Paul&rsquo;s defense before kings.`,
  calloutTitle: `Before Kings`,
  calloutBody: `Acts 25 shows the Lord governing the courts of empire as surely as he governs the church. The plots and political maneuvers meant to destroy Paul instead carry him, under Roman guard and at imperial expense, toward Rome &mdash; fulfilling the word of Acts 9:15 that he would bear Christ&rsquo;s name before kings. The innocent prisoner is never in control of the court, yet never beyond the care of his Lord.`,
};
