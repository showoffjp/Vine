...
export default function SanctificationGuide() {
  const [tab, setTab] = usePersistedState<string>("vine_sanct_g_tab", "overview");
  const [mortOpen, setMortOpen] = usePersistedState<string>("vine_sanct_g_mort", "");
  const [viewsOpen, setViewsOpen] = usePersistedState<string>("vine_sanct_g_views", "");
  const [journal, setJournal] = usePersistedState<string>("vine_sanct_g_journal", "");
