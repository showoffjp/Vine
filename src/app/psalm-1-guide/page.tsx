...
const data: SectionGuideData = {
  ...
  title: `Psalm 1`,
  intro: `The gateway psalm and the two ways &mdash; the blessed man who delights in the law of the Lord, the tree planted by streams of water, the wicked as chaff the wind drives away, and the God who knows the way of the righteous while the way of the wicked perishes.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Psalm 1 through visual teaching on the two ways, the blessed man who meditates on the law of the Lord, the tree planted by streams of water, and the chaff the wind drives away.`,
  calloutTitle: `Planted by the Streams of Living Water`,
