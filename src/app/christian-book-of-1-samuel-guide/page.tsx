...
const data: SectionGuideData = {
  ...
  intro: `From Hannah&rsquo;s prayer to the throne &mdash; the birth and call of Samuel, Israel&rsquo;s demand for a king, the rise and fall of Saul, the anointing of David, and the faith of a shepherd boy who faced a giant in the name of the LORD.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 Samuel through visual teaching on the structure of the book, the story of David and Goliath, and the truth that God looks upon the heart.`,
  calloutTitle: `To Obey Is Better Than Sacrifice`,
  calloutBody: `First Samuel traces the journey from a barren woman&rsquo;s prayer to the rise of a shepherd king, and its message endures: God hears the lowly, honors the obedient heart, and chooses not by outward appearance but by what he sees within. The LORD looks on the heart &mdash; may ours be turned wholly toward him.`,
};
