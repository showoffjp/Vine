...
const data: SectionGuideData = {
  ...
  videoIntro: `Deepen your study of Zephaniah through visual teaching on the great Day of the Lord, the rebuke of complacency, the judgment on the nations, and the tender promise that God will rejoice over his people with singing.`,
  calloutTitle: `He Will Rejoice Over You with Singing`,
  calloutBody: `Zephaniah holds together the severity and the kindness of God &mdash; the dreadful Day of the Lord and the gladsome promise of his abiding presence. To the complacent who say the Lord will do nothing, it sounds a warning; to the humble who seek the Lord, seek righteousness, and seek humility, it holds out the tender word that the Lord your God is in your midst, a mighty one who will save.`,
};
