...
const data: SectionGuideData = {
  ...
  title: `Isaiah 40`,
  intro: `&ldquo;Comfort, comfort my people&rdquo; &mdash; a chapter that turns from judgment to consolation: a voice crying in the wilderness, the word of God that stands forever, the incomparable greatness of the Creator, and the promise that those who wait for the Lord shall mount up with wings like eagles.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Isaiah 40 through visual teaching on the God who comforts his people, the voice in the wilderness, the enduring word of God, and the strength promised to those who wait on the Lord.`,
  calloutTitle: `They Who Wait for the Lord`,
  calloutBody: `Isaiah 40 speaks to the weary and the waiting in every age. The God who measured the waters in the hollow of his hand and calls the stars by name does not faint or grow weary &mdash; and he gives his own unfailing strength to those with none left. Wait on him, and he will renew your strength to mount up, to run, and above all to walk and not faint all the way home.`,
};
