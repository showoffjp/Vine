...
export default function Exodus12GuidePage() {
    ...
    <div style={{ paddingTop: "var(--header-height, 80px)", minHeight: "100vh", background: BG, color: TEXT, fontFamily: "var(--font-jost, system-ui, sans-serif)" }}>
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of Exodus 12 through video teaching on the Passover lamb, the blood on the doorposts, the night of judgment and deliverance, and Christ as our Passover sacrifice.
            </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>Christ, Our Passover Lamb, Has Been Sacrificed</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            Exodus 12 is the Old Testament&rsquo;s most detailed portrait of what God was doing in the death of his Son. The unblemished lamb, the blood applied by hyssop, the bones not broken, the destroyer turned away &mdash; every thread is gathered up in the cross of Christ. &ldquo;For Christ, our Passover lamb, has been sacrificed. Let us therefore celebrate the festival, not with the old leaven of malice and evil, but with the unleavened bread of sincerity and truth&rdquo; (1 Cor 5:7&ndash;8).
          </p>
        </div>
      </main>
    </div>
