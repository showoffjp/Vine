...
export default function Samuel2GuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            Hannah&rsquo;s magnificent song of praise, the wickedness of Eli&rsquo;s sons Hophni and Phinehas, the faithful boy Samuel, and God&rsquo;s word of judgment on Eli&rsquo;s house &mdash; a chapter of stunning contrasts at the dawn of Israel&rsquo;s monarchy.
          </p>
        </header>
        ...
        <div style={{ marginTop: "3.5rem", marginBottom: "2rem" }}>
          ...
          <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
            Deepen your study of 1 Samuel 2 through visual teaching on Hannah&rsquo;s song, the fall of Eli&rsquo;s house, the boy Samuel, and the messianic themes that run through this pivotal chapter.
          </p>
        ...
        <div style={{ marginTop: "3.5rem", background: CARD, border: `1px solid ${ACCENT}44`, borderRadius: 12, padding: "1.75rem 2rem" }}>
          <h3 style={{ color: ACCENT, fontWeight: 700, margin: "0 0 0.75rem", fontSize: "1.2rem" }}>Those Who Honor Me I Will Honor</h3>
          <p style={{ color: MUTED, lineHeight: 1.8, margin: 0 }}>
            First Samuel 2 sets two trajectories in motion that will run through the entire rest of the Samuel narrative. The house of Eli, which had received extraordinary privilege and squandered it in contempt, is under sentence of death. The boy Samuel, who grows quietly in the background, is being prepared for a ministry that will reshape Israel&rsquo;s history. And Hannah&rsquo;s song &mdash; echoed centuries later in Mary&rsquo;s Magnificat &mdash; names the God who is doing it all: the one who raises the poor from the dust, fills the hungry, and exalts the horn of his anointed.
          </p>
        </div>
      </main>
    </div>
