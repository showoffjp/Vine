...
export default function Acts17GuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 800, margin: "0 0 1rem", lineHeight: 1.15 }}>
            Acts 17 &mdash; Paul at Mars Hill
          </h1>
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            Paul&rsquo;s brilliant contextualization of the gospel to Greek philosophers at the Areopagus in Athens &mdash; engaging the Unknown God, quoting their own poets, and calling all people everywhere to repentance grounded in the resurrection of Jesus Christ.
          </p>
        </header>
        ...
        <section style={{ marginTop: "3rem" }}>
          ...
          <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 1.75rem" }}>
            Deepen your study of Acts 17 through visual teaching on Paul&rsquo;s Mars Hill sermon, the Unknown God altar in Athens, and the power of the resurrection proclamation.
          </p>
