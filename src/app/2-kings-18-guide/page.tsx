...
const data: SectionGuideData = {
  ...
  badge: `Kings Study`,
  title: `2 Kings 18`,
  intro: `Hezekiah&rsquo;s reforms and his destruction of the bronze serpent, the recap of Samaria&rsquo;s fall, Sennacherib&rsquo;s overwhelming invasion of Judah, and the Rabshakeh&rsquo;s calculated, blasphemous taunt at the wall of Jerusalem.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 2 Kings 18 through visual teaching on Hezekiah&rsquo;s faithful reforms, the destruction of Nehushtan, the pressure of Sennacherib&rsquo;s invasion, and the blasphemous taunt of the Rabshakeh at the wall.`,
  calloutTitle: `Trust Under Fire`,
  calloutBody: `2 Kings 18 holds two truths together: real faithfulness does not exempt a believer from real crisis, and the world&rsquo;s taunts grow loudest precisely when God&rsquo;s people are most cornered. Hezekiah trusted the Lord like no king before or after him &mdash; and that very trust would be tested to the breaking point at the wall of Jerusalem, where the God who is mocked proves to be the God who answers.`,
};
