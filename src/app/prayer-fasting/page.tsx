      ...
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "0 20px 60px" }}>
        ...
        {tab === "videos" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            {[
              { videoId: "W6NjAG4qp4M", title: "Fasting and Prayer", channel: "John Piper Desiring God", description: "John Piper explores the biblical theology of fasting and prayer, explaining why fasting is not an Old Testament relic but a living discipline for the Christian life." },
              { videoId: "krxcqH522uo", title: "The Discipline of Fasting", channel: "Ligonier Ministries", description: "Ligonier Ministries examines fasting as a spiritual discipline — its biblical basis, its purpose, and how it fits into the broader life of Christian devotion." },
              { videoId: "KRsuCQe7aVk", title: "Prayer and Fasting: A Guide to Biblical Practice", channel: "Tim Keller Gospel in Life", description: "Tim Keller provides a practical and theological guide to prayer and fasting, grounding the practice in Scripture and showing its relevance for the contemporary Christian." },
              { videoId: "52ZXFH1wzc8", title: "Why Should Christians Fast?", channel: "Desiring God", description: "Desiring God addresses the question of why fasting still matters for followers of Jesus, connecting the discipline to hunger for God and the return of the bridegroom." },
            ].map(v => (
