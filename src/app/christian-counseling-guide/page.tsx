...
export default function ChristianCounselingGuide() {
  const [tab, setTab] = useLocalStorage("vine_counsel_tab", "overview");
  const [modOpen, setModOpen] = useLocalStorage("vine_counsel_mod", "");
  const [sufOpen, setSufOpen] = useLocalStorage("vine_counsel_suf", "");
  const [journal, setJournal] = useLocalStorage("vine_counsel_journal", "");
