...
export default function GalatiansGuide() {
  const [activeTab, setActiveTab] = usePersistedState<string>("vine_gal_tab", "overview");
  const [openGos, setOpenGos] = usePersistedState<string>("vine_gal_gos", "");
  const [openFr, setOpenFr] = usePersistedState<string>("vine_gal_fr", "");
  const [journal, setJournal] = usePersistedState<string>("vine_gal_journal", "");
