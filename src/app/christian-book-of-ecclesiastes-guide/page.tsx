...
const data: SectionGuideData = {
  ...
  intro: `Wisdom literature&rsquo;s most surprising and modern-sounding book &mdash; the Preacher&rsquo;s search for meaning, vanity of vanities, the limits of wisdom and wealth and pleasure, a time for everything, enjoying life as a gift from God, and the call to fear God and keep his commandments.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Ecclesiastes through visual teaching on the structure of the book, the Preacher&rsquo;s search for meaning, and the call to fear God under the sun.`,
  calloutTitle: `The End of the Matter`,
  calloutBody: `Ecclesiastes strips away every illusion that life under the sun can satisfy the eternity God has set in our hearts. Its honesty about vanity and death is not despair but preparation &mdash; clearing the ground for the only conclusion that holds: fear God, receive each day as his gift, and find in him the meaning the world could never give.`,
};
