...
const data: SectionGuideData = {
  ...
  title: `2 Kings 2`,
  intro: `Elijah and Elisha&rsquo;s final journey together, Elisha&rsquo;s persistent request for a double portion of Elijah&rsquo;s spirit, the whirlwind and chariot of fire, and Elisha beginning his own miracle ministry.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 2 Kings 2 through visual teaching on Elijah&rsquo;s departure, Elisha&rsquo;s double portion, the chariot of fire, and the beginning of Elisha&rsquo;s own prophetic ministry.`,
  calloutTitle: `The Spirit of Elijah Rests on Elisha`,
  calloutBody: `Second Kings 2 teaches that God does not leave his people without a witness. When Elijah is taken up, the spirit that rested on him is poured out on his successor &mdash; not by automatic inheritance but by divine gift, received through persistent presence and earnest desire. &ldquo;The spirit of Elijah rests on Elisha&rdquo; (v.15) is the community&rsquo;s testimony that God&rsquo;s work continues past any single generation.`,
};
