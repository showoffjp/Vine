...
const data: SectionGuideData = {
  ...
  intro: `The shortest book in the Old Testament &mdash; a single chapter of fierce judgment against Edom for its pride dwelling in the high rocks, its betrayal of its brother Israel in the day of Jerusalem&rsquo;s fall, and the coming Day of the Lord when &ldquo;the kingdom shall be the Lord&rsquo;s.&rdquo;`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Obadiah through visual teaching on the pride of Edom, the ancient grudge between Esau and Jacob, the betrayal of Jerusalem, and the coming Day of the Lord when the kingdom shall be his.`,
  calloutTitle: `The Kingdom Shall Be the Lord&rsquo;s`,
  calloutBody: `Obadiah strips away every false security, exposing the pride that imagines itself beyond the reach of God and the cold betrayal that turns against its own brother. Yet its final word is not judgment but hope: the proud are brought down from their nests among the stars, the scattered are restored to their inheritance, and over the ruins of every earthly empire there rises the everlasting reign of the King &mdash; for the kingdom shall be the Lord&rsquo;s.`,
};
