...
const data: SectionGuideData = {
  ...
  intro: `The fifth gospel &mdash; the holiness of God and Isaiah&rsquo;s call, the promise of Immanuel and the Prince of Peace, comfort for the exiles, the suffering servant who bore our sins, and the vision of new heavens and a new earth.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Isaiah through visual teaching on the sweep of the book, its vision of judgment and hope, and the suffering servant of Isaiah 53 who anticipates the cross.`,
  calloutTitle: `The Word That Stands Forever`,
  calloutBody: `Isaiah holds together the holiness of God and the hope of redemption, the depth of human sin and the height of divine grace. From the throne room of chapter 6 to the suffering servant of chapter 53 to the new creation of chapter 65, it points unmistakably toward Christ &mdash; for &ldquo;the grass withers, the flower fades, but the word of our God will stand forever.&rdquo;`,
};
