...
export default function FirstCorinthians5GuidePage() {
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1.25rem 5rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: MUTED, lineHeight: 1.7, margin: 0 }}>
            Paul confronts a scandal of tolerated immorality in the Corinthian church &mdash; commanding redemptive discipline, warning that &ldquo;a little leaven leavens the whole lump,&rdquo; pointing to Christ our Passover, and drawing the line between judging those inside the church and leaving the world to God.
          </p>
        </header>
        ...
        {activeTab === "Videos" && (
          <section>
            ...
            <p style={{ color: MUTED, fontSize: "1.05rem", lineHeight: 1.8, margin: "0 0 2rem" }}>
              Deepen your study of 1 Corinthians 5 through visual teaching on tolerated sin, the redemptive purpose of church discipline, Christ our Passover lamb, and the distinction between judging those inside the church and leaving the world to God.
            </p>
