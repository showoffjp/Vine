...
const data: SectionGuideData = {
  ...
  title: `Romans 5`,
  intro: `Peace with God and the second Adam &mdash; being justified by faith we have peace with God, we rejoice in sufferings that produce hope, Christ died for us while we were still sinners, and where sin increased grace abounded all the more through Jesus Christ our Lord.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of Romans 5 through visual teaching on justification by faith, peace with God, the hope forged in suffering, the love of God shown while we were still sinners, and the contrast of Adam and Christ.`,
  calloutTitle: `Where Sin Increased, Grace Abounded All the More`,
  calloutBody: `Romans 5 moves from the settled verdict of justification to peace with God, from suffering to a hope that does not put us to shame, from our sin to the love of God poured out at the cross, and from death in Adam to abounding life in Christ. Its enduring call still sounds &mdash; to rest in the assurance of grace, to rejoice even in suffering, and to glory in the God who reconciled us while we were still sinners.`,
};
