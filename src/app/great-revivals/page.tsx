...
type Tab = "revivals" | "conditions" | "figures" | "today";
    ...
    <div style={{ background: BG, minHeight: "100vh", color: TEXT, fontFamily: "system-ui, sans-serif", paddingTop: 40 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 20px 60px" }}>
        ...
        {tab === "conditions" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {CONDITIONS.map((c, i) => (
              <div key={i} style={{ background: CARD, border: `1px solid ${expanded[c.condition] ? c.color + "40" : BORDER}`, borderRadius: 12, overflow: "hidden" }}>
                <button onClick={() => setExpanded(e => ({ ...e, [c.condition]: !e[c.condition] }))}
