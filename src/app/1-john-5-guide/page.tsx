...
const data: SectionGuideData = {
  ...
  title: `1 John 5 Chapter Guide`,
  intro: `Overcoming the world through faith in Jesus Christ &mdash; John&rsquo;s closing chapter weaves together love for God, the threefold witness to the Son, God&rsquo;s own testimony about eternal life, the assurance of salvation, confident prayer, and the final charge to keep ourselves from idols.`,
  tabs: TABS as unknown as string[],
  sections,
  videos: videoItems,
  videoHeading: `Video Teaching`,
  videoIntro: `Deepen your study of 1 John 5 through these video teachings on faith overcoming the world, the three witnesses to Christ, the assurance of eternal life, and confident prayer in God&rsquo;s name.`,
  calloutTitle: `This Is the Victory That Overcomes the World`,
  calloutBody: `First John 5 calls believers to a settled, confident faith in Jesus Christ &mdash; the Son of God who came by water and blood, who is testified to by the Spirit, and in whom alone eternal life is found. The world and its false claims do not have the final word; faith in the Son does. Keep yourself from idols, hold fast to the true God, and know that you have eternal life.`,
};
